...
import com.wl.view.ChildGridView;
import com.wl.view.MyGridView;
...
public class EnquiryDetailActivity extends BaseActivity{
    ...
    private void setData(PriceEntity bean) {
        ...
        for (int i = 1; i < lists.size(); i++) {
            ...
            if(bean.getSurcharges().get(i).getTprice()!=null){
                if(bean.getSurcharges().get(i).getGp20()!=null){
                    lists.get(i).add(bean.getSurcharges().get(i).getGp20() + Config.GP20);
                }
                if(bean.getSurcharges().get(i).getGp40()!=null){
                    lists.get(i).add(bean.getSurcharges().get(i).getGp40() + Config.GP40);
                }
                if(bean.getSurcharges().get(i).getHq40()!=null){
