    ...
    private void updateDisplay(String date) {
        switch (clickId) {
            case R.id.cls_date:
                ...
                clsDateView.setText(date + WEEK[calendar.get(java.util.Calendar.DAY_OF_WEEK) - 1]);
                break;
            case R.id.start_date:
                ...
                if (startDate.after(clsDate)) {
                    ...
                    startDateView.setText(date + WEEK[calendar.get(java.util.Calendar.DAY_OF_WEEK) - 1]);
                    bean.setEtd(date);
                }
                break;
