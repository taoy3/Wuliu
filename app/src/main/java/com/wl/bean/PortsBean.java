...
public class PortsBean implements Serializable {
    ...
    private List<PortsEntity> result;
    @Column(column = "totalCount")
    private int totalCount;

    public void setResult(List<PortsEntity> result) {
        this.result = result;
    }
    ...
    public List<PortsEntity> getResult() {
        return result;
    }
    ...
    public PortsBean(List<PortsEntity> result, String firstName) {
        this.result = result;
    }
}
