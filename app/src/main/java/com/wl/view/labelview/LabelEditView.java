...
public class LabelEditView extends RelativeLayout{
    ...
    private void init(Context context,AttributeSet attrs) {
        ...
        addViewInLayout(labelText,0,new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));
